...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../zlib/lib/ -llibzlib.dll
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../zlib/lib/ -llibzlib.dlld
else:unix: LIBS += -L$$PWD/../zlib/lib/ -llibzlib.dll
